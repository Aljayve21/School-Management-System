...
<div class="d-flex">
    <nav id="sidebar" class="sidebar bg-dark text-white">
        ...
        <ul class="nav flex-column p-2">
            <li class="nav-item">
                <a class="nav-link text-white <?= ($currentPage ?? '') === 'dashboard' ? 'active bg-success' : '' ?>" href="<?= url('teacher/dashboard') ?>">
                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= ($currentPage ?? '') === 'classes' ? 'active bg-success' : '' ?>" href="<?= url('teacher/classes') ?>">
                    <i class="bi bi-calendar-week me-2"></i> My Classes
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= ($currentPage ?? '') === 'grades' ? 'active bg-success' : '' ?>" href="<?= url('teacher/grades') ?>">
                    <i class="bi bi-journal-check me-2"></i> Grades
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= ($currentPage ?? '') === 'announcements' ? 'active bg-success' : '' ?>" href="<?= url('teacher/announcements') ?>">
    ...
    <main class="main-content flex-grow-1">
        <div class="topbar bg-white shadow-sm p-3 d-flex justify-content-between align-items-center">
            ...
            <div class="topbar-user d-flex align-items-center ms-2">
                <span class="me-2 d-none d-sm-inline"><i class="bi bi-person-circle"></i> <?= sanitize($session->userName() ?? 'Teacher') ?></span>
