...
<div class="row g-3 g-md-4 mb-4">
    <div class="col-4">
        <div class="card border-0 shadow-sm bg-success text-white stat-card">
            <div class="card-body"><h6 class="opacity-75">My Subjects</h6><h2 class="mb-0"><?= count($subjects ?? []) ?></h2></div>
        </div>
    </div>
    <div class="col-4">
        <div class="card border-0 shadow-sm bg-info text-white stat-card">
            <div class="card-body"><h6 class="opacity-75">My Schedules</h6><h2 class="mb-0"><?= count($schedules ?? []) ?></h2></div>
        </div>
    </div>
    <div class="col-4">
...
<div class="row g-3 g-md-4">
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white"><h6 class="mb-0">My Schedule This Week</h6></div>
            <div class="card-body">
                ...
                <?php else: ?>
                <p class="text-muted text-center">No schedule assigned yet.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
